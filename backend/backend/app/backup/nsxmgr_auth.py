...
def get_basic_auth_stub_config(
    user: str, password: str, nsx_host: str, tcp_port: int = 443
) -> StubConfiguration:
    """
...
def get_session_auth_stub_config(
    user: str, password: str, nsx_host: str, tcp_port: int = 443
) -> StubConfiguration:
    """
...
def get_session_auth_api_client(
    user: str, password: str, nsx_host: str, tcp_port: int = 443
) -> ApiClient:
...
def create_nsx_api_client(
    ...
    return create_api_client(nsx_client, user, password, nsx_host, tcp_port, auth_type)
